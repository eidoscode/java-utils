...
public final class CompressUtils {
     ...
     *             if an error occur
     */
    public static void copyZipToTempDirAndExtract(String resourcePathFile, String tempFileName, String tempDir, String destinyDir) throws IOException {
        // TODO
        // int totalBytes =
        // StreamUtils.countBytes(StreamUtils.class.getClassLoader().getResourceAsStream(resourcePathFile));
        // String tempZipFile = StringUtils.buildFilePath(tempDir,
        // tempFileName);
        // FileOutputStream fos = new FileOutputStream(tempZipFile);
        // StreamUtils.copyStream(StreamUtils.class.getClassLoader().getResourceAsStream(resourcePathFile),
        // fos,
        // totalBytes);
        // StreamUtils.closeSilently(fos);
        // StreamUtils.extractZipRecursively(tempZipFile, destinyDir);
    }
